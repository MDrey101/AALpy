...
def run_Lstar(alphabet: list, sul: SUL, eq_oracle: Oracle, automaton_type,
    ...
    while True:
        ...
        if not cex_processing:
            ...
            print("xxxxxxxxxxxxxxxxxxxx", s_to_update, "xxxxxxxxxxxxxxxxxxxxxx")
            for p in added_rows:
                s_to_update.extend([p + (a,) for a in alphabet])
                print("ddddddddddddddddddddddddd", s_to_update, "ddddddddddddddddddddddddd")

            print("wwwwwwwwwwwwwwwwwwwwwwwwww", observation_table.T, "wwwwwwwwwwwwwwwwwwwwwwwwww")
            observation_table.update_obs_table(s_set=s_to_update)
            print("zzzzzzzzzzzzzzzzzzzzzzzzzz", observation_table.T, "zzzzzzzzzzzzzzzzzzzzzzzzzz")
            continue
